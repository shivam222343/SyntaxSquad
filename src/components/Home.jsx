...
function Home() {
  return (
    <div className='flext items-center mx-56 gap-9 '>
      <h1 className='font-bold font-sans text-[50px] mt-20 text-center'> <span className='text-red-500'>Plan Your New Trip With Us :</span> Personalized Itineraries at Your Fingertips</h1>
